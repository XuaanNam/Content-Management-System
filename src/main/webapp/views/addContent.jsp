...
<form action="${pageContext.request.contextPath}/addContentServlet"
    method="POST" class="form" id="form-add" onsubmit="return validate()">
            ...
            <div>
                <div class="form-group">
                    <label for="title-box" class="heading-name">Tittle</label> <input
                        id="title-box" name="title" type="text" required 
                ...
                <div class="form-group">
                    ...
                    <textarea name="brief" id="brief-box" cols="115" rows="4" required
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content-box" cols="115" rows="10" required
                        class="input-box-section"></textarea>
                    <span class="form-message"></span>
                </div>
